...
exports.default1680013658221 = void 0;
class default1680013658221 {
    constructor() {
        this.name = 'default1680013658221';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`company\` ADD UNIQUE INDEX \`IDX_13cf32396fc6f658e3e641209d\` (\`acronym\`)`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`product\` ADD CONSTRAINT \`FK_618194d24a7ea86a165d7ec628e\` FOREIGN KEY (\`productCategoryId\`) REFERENCES \`category\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`company\` DROP INDEX \`IDX_13cf32396fc6f658e3e641209d\``);
...
exports.default1680013658221 = default1680013658221;
