...
exports.default1680113627689 = void 0;
class default1680113627689 {
    constructor() {
        this.name = 'default1680113627689';
    }
    async up(queryRunner) {
        await queryRunner.query(`ALTER TABLE \`product\` ADD \`checkProductId\` int NULL`);
...
exports.default1680113627689 = default1680113627689;
