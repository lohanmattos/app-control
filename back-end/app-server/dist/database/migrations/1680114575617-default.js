...
exports.default1680114575617 = void 0;
class default1680114575617 {
    constructor() {
        this.name = 'default1680114575617';
    }
    async up(queryRunner) {
        await queryRunner.query(`ALTER TABLE \`check_product\` ADD \`sectionId\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`check_product\` ADD \`userId\` int NULL`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`product\` ADD CONSTRAINT \`FK_618194d24a7ea86a165d7ec628e\` FOREIGN KEY (\`productCategoryId\`) REFERENCES \`category\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`product\` ADD CONSTRAINT \`FK_9f43b335df2357a0b3149e6bb5c\` FOREIGN KEY (\`sectionId\`) REFERENCES \`section\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`check_product\` DROP COLUMN \`userId\``);
        await queryRunner.query(`ALTER TABLE \`check_product\` DROP COLUMN \`sectionId\``);
    }
}
exports.default1680114575617 = default1680114575617;
