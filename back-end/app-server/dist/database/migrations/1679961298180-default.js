...
exports.default1679961298180 = void 0;
class default1679961298180 {
    constructor() {
        this.name = 'default1679961298180';
    }
    async up(queryRunner) {
        await queryRunner.query(`DROP INDEX \`FK_8a0634703b54978a2fa6f775209\` ON \`employee\``);
        await queryRunner.query(`DROP INDEX \`FK_618194d24a7ea86a165d7ec628e\` ON \`product\``);
        await queryRunner.query(`ALTER TABLE \`employee\` ADD UNIQUE INDEX \`IDX_cc5bc3cbcb7312fbc898749c5b\` (\`cpf\`)`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`employee\` DROP COLUMN \`createdAt\``);
        await queryRunner.query(`ALTER TABLE \`employee\` ADD \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`employee\` DROP INDEX \`IDX_cc5bc3cbcb7312fbc898749c5b\``);
        await queryRunner.query(`CREATE INDEX \`FK_618194d24a7ea86a165d7ec628e\` ON \`product\` (\`productCategoryId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_8a0634703b54978a2fa6f775209\` ON \`employee\` (\`sectionId\`)`);
    }
}
exports.default1679961298180 = default1679961298180;
