...
exports.default1680114267831 = void 0;
class default1680114267831 {
    constructor() {
        this.name = 'default1680114267831';
    }
    async up(queryRunner) {
        await queryRunner.query(`ALTER TABLE \`product\` DROP FOREIGN KEY \`FK_c864ab8454ed95237e3721ab1cd\``);
        await queryRunner.query(`ALTER TABLE \`product\` DROP COLUMN \`checkProductId\``);
        await queryRunner.query(`ALTER TABLE \`check_product\` ADD \`productCodeId\` int NULL`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`employee\` ADD CONSTRAINT \`FK_8a0634703b54978a2fa6f775209\` FOREIGN KEY (\`sectionId\`) REFERENCES \`section\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`employee\` ADD CONSTRAINT \`FK_f4b0d329c4a3cf79ffe9d565047\` FOREIGN KEY (\`userId\`) REFERENCES \`user\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`check_product\` DROP COLUMN \`productCodeId\``);
        await queryRunner.query(`ALTER TABLE \`product\` ADD \`checkProductId\` int NULL DEFAULT 'NULL'`);
...
exports.default1680114267831 = default1680114267831;
