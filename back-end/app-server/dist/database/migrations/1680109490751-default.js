...
exports.default1680109490751 = void 0;
class default1680109490751 {
    constructor() {
        this.name = 'default1680109490751';
    }
    async up(queryRunner) {
        await queryRunner.query(`ALTER TABLE \`product\` ADD \`codeId\` int NULL`);
...
exports.default1680109490751 = default1680109490751;
