...
exports.default1680109036315 = void 0;
class default1680109036315 {
    constructor() {
        this.name = 'default1680109036315';
    }
    async up(queryRunner) {
        await queryRunner.query(`DROP INDEX \`FK_8a0634703b54978a2fa6f775209\` ON \`employee\``);
        await queryRunner.query(`DROP INDEX \`FK_9f43b335df2357a0b3149e6bb5c\` ON \`product\``);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`CREATE INDEX \`FK_9f43b335df2357a0b3149e6bb5c\` ON \`product\` (\`sectionId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_8a0634703b54978a2fa6f775209\` ON \`employee\` (\`sectionId\`)`);
    }
}
exports.default1680109036315 = default1680109036315;
